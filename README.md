# Dayelis
This is the bot maintained by me for personal use in my TTRPG group with my close friends. This bot's purpose is to make scheduling a bit easier, and have some tools available for different TTRPG based activities.
